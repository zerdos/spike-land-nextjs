...
Given(
  "the user has referrals with different statuses",
...
Given(
  "the referral API is slow to respond",
  async function(this: CustomWorld) {
...
// When steps
When(
  "I click the copy referral link button",
  async function(this: CustomWorld) {
...
When(
  "the referral data loads successfully",
  async function(this: CustomWorld) {
...
// Then steps
Then(
  "I should see the referral link input field",
  async function(this: CustomWorld) {
...
Then(
  "the copy button should show {string} text",
...
Then(
  "the referral link should be in the clipboard",
  async function(this: CustomWorld) {
...
Then(
  "I should see {string} statistic card",
...
Then(
  "I should see the referral code in a code element",
  async function(this: CustomWorld) {
...
Then(
  "I should see the referred users table",
  async function(this: CustomWorld) {
...
Then(
  "the referral link input should contain a valid URL",
  async function(this: CustomWorld) {
    const input = this.page.locator('input[type="text"][readonly]').first();
    const value = await input.inputValue();
...
Then(
  "the URL should include the base domain",
  async function(this: CustomWorld) {
    const input = this.page.locator('input[type="text"][readonly]').first();
    const value = await input.inputValue();
...
Then(
  "a new window should open with Twitter share URL",
  async function(this: CustomWorld) {
