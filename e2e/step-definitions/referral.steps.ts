...
Then('the referral link should contain the user\'s referral code', async function (this: CustomWorld) {
  const input = this.page.locator('input[type="text"][readonly]').first();
...
Then('the {string} share button should be clickable', async function (this: CustomWorld, platform: string) {
...
Then('the table should have {string} column header', async function (this: CustomWorld, headerText: string) {
  const header = this.page.locator('th', { hasText: headerText });
  await expect(header).toBeVisible();
});

Then('completed referrals should show green {string} badge', async function (this: CustomWorld, badgeText: string) {
  const badge = this.page.locator('[class*="badge"]').filter({ hasText: badgeText }).first();
  await expect(badge).toBeVisible();
});

Then('pending referrals should show yellow {string} badge', async function (this: CustomWorld, badgeText: string) {
  const badge = this.page.locator('[class*="badge"]').filter({ hasText: badgeText }).first();
  await expect(badge).toBeVisible();
});
...
Then('{string} should show {int}', async function (this: CustomWorld, statName: string, expectedValue: number) {
