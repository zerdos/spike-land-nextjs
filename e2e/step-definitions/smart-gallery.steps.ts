...
function createMockGalleryImage(
  ...
  return {
    ...
    originalUrl: `https://placehold.co/600x400/gray/white?text=Original${index}`,
    enhancedUrl: hasEnhanced
      ? `https://placehold.co/600x400/green/white?text=Enhanced${index}`
      : null,
    url: `https://placehold.co/600x400/gray/white?text=Image${index}`,
    width: 600,
    height: 400,
  };
}
