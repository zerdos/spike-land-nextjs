    ...
    const galleryItems = [
      {
        ...
        category: "PORTRAIT",
        originalUrl: "https://placehold.co/400x300/purple/white.png?text=Portrait",
        enhancedUrl: "https://placehold.co/400x300/purple/white.png?text=Portrait+Enhanced",
        isActive: true,
        sortOrder: 1,
        sourceImageId: "img-1",
        sourceJobId: "job-1",
      ...
      },
      {
        ...
        category: "LANDSCAPE",
        originalUrl: "https://placehold.co/400x300/green/white.png?text=Landscape",
        enhancedUrl: "https://placehold.co/400x300/green/white.png?text=Landscape+Enhanced",
        isActive: false,
        sortOrder: 2,
        sourceImageId: "img-2",
        sourceJobId: "job-2",
          ...
          body: JSON.stringify({
            items: [
              ...
              },
              {
                ...
                isActive: true,
                sortOrder: 3,
                originalUrl: "https://placehold.co/400x300/blue/white.png?text=Product",
                enhancedUrl: "https://placehold.co/400x300/blue/white.png?text=Product+Enhanced",
                createdAt: new Date().toISOString(),
                updatedAt: new Date().toISOString(),
              },
              {
                ...
                isActive: true,
                sortOrder: 4,
                originalUrl: "https://placehold.co/400x300/orange/white.png?text=Architecture",
                enhancedUrl:
                  "https://placehold.co/400x300/orange/white.png?text=Architecture+Enhanced",
                createdAt: new Date().toISOString(),
                updatedAt: new Date().toISOString(),
              },
            ],
      ...
      await route.fulfill({
        ...
        body: JSON.stringify({
          images: [
            {
              id: "img-1",
              originalUrl: "https://placehold.co/400x300/purple/white.png?text=Test",
              ...
              enhancementJobs: [
                {
                  id: "job-1",
                  tier: "TIER_1K",
                  enhancedUrl: "https://placehold.co/400x300/purple/white.png?text=Enhanced",
                  createdAt: new Date().toISOString(),
                },
              ],
            },
      ...
      if (method === "GET") {
        ...
        const newItem = {
          ...
          originalUrl: body.originalUrl ||
            "https://placehold.co/400x300/purple/white.png?text=Test",
          enhancedUrl: body.enhancedUrl ||
            "https://placehold.co/400x300/purple/white.png?text=Enhanced",
          isActive: true,
    ...
    const galleryItems = [
      {
        ...
        isActive: true,
        sortOrder: 1,
        originalUrl: "https://placehold.co/400x300/purple/white.png?text=First",
        enhancedUrl: "https://placehold.co/400x300/purple/white.png?text=First+Enhanced",
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        ...
        isActive: true,
        sortOrder: 2,
        originalUrl: "https://placehold.co/400x300/green/white.png?text=Second",
        enhancedUrl: "https://placehold.co/400x300/green/white.png?text=Second+Enhanced",
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
    ];
