...
Given(
  "there is a bug report with user agent in the system",
...
Given(
  "there is NEW feedback in the system",
  async function(this: CustomWorld) {
    await this.page.route("**/api/admin/feedback**", async (route) => {
      if (route.request().method() === "GET") {
        await route.fulfill({
...
Given(
  "there is feedback of all types in the system",
  async function(this: CustomWorld) {
    await this.page.route("**/api/admin/feedback**", async (route) => {
      if (route.request().method() === "GET") {
        await route.fulfill({
...
Then(
  "each feedback item should display the submission date",
  async function(this: CustomWorld) {
...
Then(
  "each feedback item should display a type badge",
  async function(this: CustomWorld) {
...
Then(
  "each feedback item should display a status badge",
  async function(this: CustomWorld) {
    const statusBadges = this.page.locator("tbody tr").first().locator(
      '[class*="Badge"]',
    );
...
Then(
  "the feedback list should only show NEW status items",
  async function(this: CustomWorld) {
...
Then(
  "the feedback list should only show REVIEWED status items",
  async function(this: CustomWorld) {
    await this.page.waitForLoadState("networkidle");
  },
);
...
Then(
  "the feedback list should only show RESOLVED status items",
  async function(this: CustomWorld) {
    await this.page.waitForLoadState("networkidle");
  },
);
...
Then(
  "the feedback list should only show BUG type items",
  async function(this: CustomWorld) {
    await this.page.waitForLoadState("networkidle");
  },
);
...
Then(
  "the feedback list should only show IDEA type items",
  async function(this: CustomWorld) {
    await this.page.waitForLoadState("networkidle");
  },
);
...
Then(
  "the feedback list should only show OTHER type items",
  async function(this: CustomWorld) {
    await this.page.waitForLoadState("networkidle");
  },
);
...
Then(
  "the feedback list should only show NEW BUG items",
  async function(this: CustomWorld) {
    await this.page.waitForLoadState("networkidle");
  },
);
...
Then(
  "the status badge should update to green",
  async function(this: CustomWorld) {
    await this.page.waitForLoadState("networkidle");
  },
);
...
Then(
  "the status badge should update to gray",
  async function(this: CustomWorld) {
    await this.page.waitForLoadState("networkidle");
  },
);
...
Then(
  "the list should reflect the new status",
  async function(this: CustomWorld) {
    await this.page.waitForLoadState("networkidle");
  },
);
...
Then("BUG type badge should be red", async function(this: CustomWorld) {
  const badge = this.page.locator('[class*="Badge"]').filter({ hasText: "BUG" })
    .first();
