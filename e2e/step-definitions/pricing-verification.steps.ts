...
When(
  "I click the buy button for a token pack",
...
Then(
  "I should not see any subscription options",
  async function(this: CustomWorld) {
    const subscriptionText = this.page.getByText(
...
Then(
  "each token pack should display:",
...
Then(
  "all prices should be displayed in GBP currency",
  async function(this: CustomWorld) {
...
Then(
  "each pack should show price per token",
  async function(this: CustomWorld) {
