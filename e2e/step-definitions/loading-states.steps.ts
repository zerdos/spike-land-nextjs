...
Then(
  "loading.tsx should exist for my-apps route",
...
Then(
  "loading.tsx should exist for my-apps\\/new route",
  function(this: CustomWorld) {
...
Then(
  "loading.tsx should exist for profile route",
  function(this: CustomWorld) {
...
Then(
  "loading.tsx should exist for settings route",
  function(this: CustomWorld) {
    const loadingPath = path.join(
      process.cwd(),
...
Then(
  "skeleton.tsx should exist in components\\/ui",
  function(this: CustomWorld) {
...
Then(
  "all loading files should have corresponding test files",
  function(this: CustomWorld) {
    const loadingFiles = [
...
Then(
  "all skeleton components should have corresponding test files",
  function(this: CustomWorld) {
