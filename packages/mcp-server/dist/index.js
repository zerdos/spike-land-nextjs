...
const GenerateImageSchema = z.object({
    ...
    tier: z
        ...
        .optional()
        .default("TIER_1K")
        .describe("Quality tier: TIER_1K (1024px, 2 tokens), TIER_2K (2048px, 5 tokens), TIER_4K (4096px, 10 tokens)"),
    negative_prompt: z
        .string()
        .optional()
...
const ModifyImageSchema = z.object({
    ...
    image_url: z.string().optional().describe("URL of the image to modify (provide either image_url or image_base64)"),
    image_base64: z.string().optional().describe("Base64-encoded image data (provide either image_url or image_base64)"),
    mime_type: z
        .string()
        .optional()
        .default("image/jpeg")
