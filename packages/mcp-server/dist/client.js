...
export class SpikeLandClient {
    ...
    async generateImage(params) {
        return this.request("/api/mcp/generate", "POST", {
     ...
     */
    async modifyImage(params) {
        return this.request("/api/mcp/modify", "POST", {
            prompt: params.prompt,
            image: params.image,
    ...
    async getJobStatus(jobId) {
        const job = await this.request(`/api/mcp/jobs/${jobId}`);
        return { job };
    }
    /**
     ...
     */
    async getBalance() {
        return this.request("/api/mcp/balance");
    }
    /**
