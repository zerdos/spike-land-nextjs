            ...
            >
              <div
                style={{
                  ...
                  transform: `scale(${interpolate(frame, [60, 90], [0.8, 1], {
                    extrapolateLeft: "clamp",
                    extrapolateRight: "clamp",
                  })})`,
                }}
      ...
      <Sequence from={600} durationInFrames={300}>
        ...
        >
          {[
            ...
            { code: "SyntaxError: Unexpected token '}'", d: 30 },
            { code: "TypeError: Cannot call undefined as function", d: 60 },
            { code: "RangeError: Maximum call stack size exceeded", d: 90 },
          ].map((err, i) => {
      ...
      <Sequence from={1200} durationInFrames={600}>
        <AbsoluteFill>
          <GradientMesh
            ...
            opacity={interpolate(frame, [1200, 1260], [0, 1], {
              extrapolateLeft: "clamp",
              extrapolateRight: "clamp",
            })}
          />
