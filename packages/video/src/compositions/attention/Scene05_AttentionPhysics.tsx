    ...
    <AbsoluteFill style={{ backgroundColor: COLORS.darkBg }}>
      ...
      {frame >= 300 && frame < 800 && (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 40 }}>
            <KineticText text="N² Complexity" fontSize={60} color={COLORS.cyan} type="reveal" />
            <TokenFlow 
                text="Every token looks at every other token" 
                showConnections={true} 
                delay={20}
            />
            <div style={{ color: COLORS.textMuted, fontSize: 24 }}>
      ...
      {frame >= 800 && frame < 1400 && (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 60 }}>
            <KineticText text="The Attention Pie" fontSize={60} color={COLORS.cyan} type="reveal" />
            ...
            <div style={{ fontSize: 24, fontWeight: 600, color: COLORS.fuchsia }}>
        ...
        <AbsoluteFill>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
                ...
                <div style={{ marginTop: 100 }}>
                    <KineticText text="The signal gets completely diluted" fontSize={50} color="white" type="reveal" />
                </div>
            </div>
        </AbsoluteFill>
      )}
      ...
      {frame >= 2000 && (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 60, padding: 80 }}>
            <div style={{ fontSize: 80, color: COLORS.error, fontWeight: 900, textAlign: 'center' }}>
