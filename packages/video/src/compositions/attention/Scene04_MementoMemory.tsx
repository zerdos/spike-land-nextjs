    ...
    <AbsoluteFill>
      ...
      {frame >= 300 && frame < 800 && (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 40 }}>
            <div style={{ fontSize: 60, fontWeight: 800, color: COLORS.fuchsia, marginBottom: 20 }}>TOTAL AMNESIA</div>
            ...
            <div style={{ color: COLORS.textMuted, fontSize: 30, fontStyle: 'italic' }}>
            ...
            left={
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 40 }}>
                    <MementoCard
                        ...
                        rotation={-5}
                    />
                    <div style={{ fontSize: 36, fontWeight: 600, color: COLORS.cyan }}>THE TATTOO</div>
                </div>
            }
            right={
