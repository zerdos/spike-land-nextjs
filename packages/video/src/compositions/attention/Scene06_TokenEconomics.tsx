    ...
    <AbsoluteFill style={{ backgroundColor: COLORS.darkBg }}>
      ...
      {frame >= 300 && frame < 800 && (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 60 }}>
            <KineticText text="The Price of Creation" fontSize={60} color={COLORS.cyan} type="reveal" />
            ...
            <div style={{ display: 'flex', gap: 60, alignItems: 'center' }}>
                <div style={{ 
                    ...
                    <div style={{ fontSize: 24, color: COLORS.cyan, marginBottom: 10 }}>INPUT (Reading)</div>
                    <div style={{ fontSize: 48, fontWeight: 900, color: 'white' }}>$5/M</div>
                    <div style={{ fontSize: 18, color: COLORS.textMuted, marginTop: 10 }}>CHEAP / PARALLEL</div>
                </div>

                <div style={{ fontSize: 60, color: COLORS.textMuted }}>vs</div>
                ...
                <div style={{ 
                    ...
                    <div style={{ fontSize: 24, color: COLORS.fuchsia, marginBottom: 10 }}>OUTPUT (Writing)</div>
                    <div style={{ fontSize: 48, fontWeight: 900, color: 'white' }}>$25/M</div>
                    <div style={{ fontSize: 18, color: COLORS.textMuted, marginTop: 10 }}>5X COST / SEQUENTIAL</div>
                </div>
            </div>
        </div>
      )}
        ...
        <SplitLayout
            left={
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
                    <div style={{ fontSize: 32, fontWeight: 700, color: COLORS.cyan }}>PRE-FILL (Reading)</div>
                    <div style={{ 
                        display: 'grid', 
                    ...
                    <div style={{ color: COLORS.textSecondary, marginTop: 20 }}>ALL AT ONCE</div>
                </div>
            }
            right={
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
                    <div style={{ fontSize: 32, fontWeight: 700, color: COLORS.fuchsia }}>DECODE (Writing)</div>
                    <div style={{ 
                        display: 'grid', 
                        gridTemplateColumns: 'repeat(10, 1fr)', 
                        gap: 10, 
                    ...
                    <div style={{ color: COLORS.textSecondary, marginTop: 20 }}>ONE BY ONE</div>
                </div>
            }
        />
      )}
      ...
      {frame >= 2000 && (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 60, padding: 100 }}>
            <KineticText text="The Effort Inversion" fontSize={60} color={COLORS.cyan} type="reveal" />
            
            <div style={{ display: 'flex', gap: 100, width: '100%', justifyContent: 'center' }}>
                <div style={{ textAlign: 'center' }}>
                    <div style={{ fontSize: 24, color: COLORS.textMuted, marginBottom: 20 }}>OLD WORLD</div>
                    ...
                    <div style={{ marginTop: 20 }}>80% Iteration</div>
                </div>

                <div style={{ fontSize: 60, alignSelf: 'center' }}>→</div>

                <div style={{ textAlign: 'center' }}>
                    <div style={{ fontSize: 24, color: COLORS.cyan, marginBottom: 20 }}>NEW WORLD</div>
                    <div style={{ height: 300, width: 80, backgroundColor: COLORS.darkBorder, borderRadius: 8, overflow: 'hidden', display: 'flex', flexDirection: 'column-reverse' }}>
                        <div style={{ height: '20%', backgroundColor: COLORS.fuchsia }} />
                        <div style={{ height: '80%', backgroundColor: COLORS.cyan }} />
                    </div>
                    <div style={{ marginTop: 20 }}>80% Context</div>
                </div>
            </div>
            
            <div style={{ fontSize: 24, color: COLORS.cyan, fontWeight: 700, letterSpacing: 2 }}>PROMPT CACHING ENABLES THE SHIFT</div>
        </div>
      )}
    </AbsoluteFill>
  );
