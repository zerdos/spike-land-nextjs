...
import { FunctionComponent, ClassComponent, HostRoot, HostComponent, HostText, Fragment, ContextProvider, ContextConsumer, ForwardRef, MemoComponent, LazyComponent, SuspenseComponent, } from './ReactWorkTags.js';
import { REACT_FRAGMENT_TYPE, REACT_CONTEXT_TYPE, REACT_CONSUMER_TYPE, REACT_FORWARD_REF_TYPE, REACT_MEMO_TYPE, REACT_LAZY_TYPE, REACT_SUSPENSE_TYPE, } from '../react/ReactSymbols.js';
...
export function createFiberFromTypeAndProps(type, key, pendingProps, lanes) {
...
export function createFiberFromFragment(elements, lanes, key) {
    const fiber = createFiber(Fragment, elements, key);
    fiber.lanes = lanes;
    return fiber;
}
function createFiberFromSuspense(pendingProps, lanes, key) {
...
//# sourceMappingURL=ReactFiber.js.map