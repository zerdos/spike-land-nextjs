...
export declare function mapChildren(children: ReactNode, func: (child: ReactNode, index: number) => ReactNode, context?: unknown): ReactNode[] | null | undefined;
export declare function forEachChildren(children: ReactNode, forEachFunc: (child: ReactNode, index: number) => void, forEachContext?: unknown): void;
