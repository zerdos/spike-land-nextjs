...
| `e2e/features/orbit-relay-approval-workflow.feature` | "Approve a pending draft"                                                  | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Audit logs include request metadata"                                      | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Cannot access drafts from another workspace"                              | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Cannot approve an already approved draft"                                 | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Cannot edit an approved draft"                                            | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Cannot reject an already rejected draft"                                  | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Cannot send a pending draft"                                              | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Complete audit trail for draft lifecycle"                                 | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Edit a pending draft"                                                     | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Edit classifies complete rewrites correctly"                              | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Edit classifies hashtag changes as platform formatting"                   | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Edit classifies minor tweaks correctly"                                   | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Fetch audit logs for a specific draft"                                    | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Handle draft not found"                                                   | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Mark approved draft as sent"                                              | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Mark draft as failed"                                                     | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Multiple team members can approve drafts"                                 | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Only admins can update approval settings"                                 | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "Reject a pending draft with reason"                                       | Investigate |
| `e2e/features/orbit-relay-approval-workflow.feature` | "View edit history"                                                        | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Analyze positive sentiment message"                                       | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Analyze question intent"                                                  | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Approve a draft"                                                          | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Cannot access drafts from another workspace"                              | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Detect escalation-worthy messages"                                        | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Drafts align with brand voice settings"                                   | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Drafts respect guardrails"                                                | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Drafts respect vocabulary rules"                                          | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Drafts without brand profile use default tone"                            | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Generate drafts with custom instructions"                                 | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Generate drafts with custom number of options"                            | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Generate response drafts for an inbox item"                               | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Get single draft details"                                                 | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Handle AI service failure gracefully"                                     | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Handle inbox item not found"                                              | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Handle unauthorized access"                                               | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Handle workspace not found"                                               | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Inbox status updates after draft generation"                              | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Inbox status updates after sending reply"                                 | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Instagram drafts include hashtag suggestions"                             | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "LinkedIn drafts can be longer"                                            | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Multiple team members can access drafts"                                  | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Regenerate drafts with feedback"                                          | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Reject a draft"                                                           | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Retrieve drafts for an inbox item"                                        | Investigate |
| `e2e/features/orbit-relay-drafts.feature`            | "Twitter drafts respect 280 character limit"                               | Investigate |
