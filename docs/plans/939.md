...
## ⚠️ Correction: Engagement Fetchers, Not Social Clients
...
1. ✏️ `src/lib/social/platform-api/twitter/engagement-fetcher.ts`
2. ✏️ `src/lib/social/platform-api/facebook/engagement-fetcher.ts`  
3. ✏️ `src/lib/social/platform-api/linkedin/engagement-fetcher.ts`
4. ✏️ `src/lib/social/platform-api/tiktok/engagement-fetcher.ts`

### New Infrastructure (3 files)
5. ➕ `src/lib/social/platform-api/errors.ts`
6. ➕ `src/lib/social/platform-api/config.ts` (API base URLs, versions)
7. ➕ `src/lib/social/platform-api/__tests__/integration.test.ts`

### Unit Tests (4 files)  
8. ➕ `src/lib/social/platform-api/twitter/engagement-fetcher.test.ts`
9. ➕ `src/lib/social/platform-api/facebook/engagement-fetcher.test.ts`
10. ➕ `src/lib/social/platform-api/linkedin/engagement-fetcher.test.ts`
11. ➕ `src/lib/social/platform-api/tiktok/engagement-fetcher.test.ts`

### Config Updates (2 files)
12. ✏️ `.env.example` (add TikTok credentials if missing)
13. ✏️ `src/lib/social/platform-api/engagement-fetcher-factory.ts` (retry logic)
...
❌ YouTube engagement fetchers (don't exist yet)  
❌ Discord engagement fetchers (don't exist yet)  
❌ Real-time metrics streaming (webhooks)  
❌ Historical analytics  
❌ Paid ad metrics
❌ Creating TikTok social client (separate feature)
❌ Caching layer
