...
About fifteen years ago, I went to a developer conference in Budapest. The topic was Mocha and unit testing. This was before Jest had eaten the world, before testing was a given on every project. Testing was still something you had to argue for.
...
"This is great for logic," the person said. "But what about the UI? How do you test what the user actually sees?"

The presenter paused. Then he shrugged.

"We don't test UI. Your eyes are enough."
...
The remaining E2E tests do what they should have always done: verify that the page renders, that the buttons are clickable, that the visual design is correct. Pure UI concerns. "Your eyes are enough" — except now your eyes are Playwright running a handful of fast visual checks, not a hundred slow business logic simulations.
