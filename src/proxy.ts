...
export async function proxy(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    connect-src 'self' blob: data: https://testing.spike.land wss://testing.spike.land https://*.r2.dev https://*.r2.cloudflarestorage.com https://generativelanguage.googleapis.com https://va.vercel-analytics.com https://vitals.vercel-insights.com https://*.ingest.de.sentry.io https://www.facebook.com https://connect.facebook.net https://vercel.live https://fonts.gstatic.com https://fonts.googleapis.com wss://ws-us3.pusher.com wss://*.peerjs.com;
