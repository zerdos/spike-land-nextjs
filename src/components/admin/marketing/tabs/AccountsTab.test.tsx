...
import { mockMarketingData, mockCampaignsData, createFetchMock } from "@/test-utils/marketing-mocks";
...
describe("AccountsTab", () => {
    ...
    it("handles account disconnection", async () => {
        ...
        await waitFor(() => {
            expect(global.fetch).toHaveBeenCalledWith("/api/admin/marketing/accounts", expect.objectContaining({
                method: "DELETE"
            }));
