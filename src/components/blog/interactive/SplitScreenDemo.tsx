...
const LeftSide = () => (
  <div className="w-full h-full bg-slate-950 flex flex-col p-8 font-mono text-sm">
...
const RightSide = () => (
  <div className="w-full h-full bg-red-950/20 flex flex-col p-8 font-mono text-sm">
...
export function SplitScreenDemo() {
  ...
  return (
    <div className="my-8 rounded-xl overflow-hidden border border-border aspect-video group relative">
      <SplitScreenCore
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-background/80 backdrop-blur-md px-4 py-2 rounded-full text-xs font-mono text-muted-foreground border border-border pointer-events-none">
