    ...
    <div ref={ref} className="my-16 rounded-2xl overflow-hidden border border-white/10 aspect-video bg-[#0a0a0f] relative group">
      ...
      <div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity">
        <button 
          ...
          className="px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full text-[10px] text-white/70 uppercase font-bold tracking-widest backdrop-blur-md"
        >
          Replay Animation
        </button>
      </div>
