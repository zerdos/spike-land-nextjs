...
describe('Tabs Component', () => {
  ...
  describe('TabsList', () => {
    ...
    it('should have default styling classes', () => {
      ...
      const list = screen.getByRole('tablist')
      expect(list).toHaveClass('inline-flex', 'h-9', 'items-center', 'justify-center', 'rounded-lg', 'bg-muted', 'p-1', 'text-muted-foreground')
    })
  ...
  describe('TabsTrigger', () => {
    ...
    it('should have default styling classes', () => {
      ...
      const trigger = screen.getByRole('tab', { name: 'Tab 1' })
      expect(trigger).toHaveClass('inline-flex', 'items-center', 'justify-center', 'whitespace-nowrap', 'rounded-md', 'px-3', 'py-1', 'text-sm', 'font-medium')
    })
