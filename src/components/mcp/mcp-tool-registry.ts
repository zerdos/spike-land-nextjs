...
export const MCP_CATEGORIES: McpCategory[] = [
  ...
  },
  {
    id: "pixel",
    name: "Pixel",
    description: "AI image generation, albums, galleries, and enhancement pipelines",
    icon: "Palette",
    color: "fuchsia",
    toolCount: 0,
    tier: "free",
  },
  {
    id: "apps",
    name: "Apps",
    description: "AI-generated app management, versioning, and deployment",
    icon: "AppWindow",
    color: "green",
    toolCount: 0,
    tier: "free",
  },
  {
    id: "create",
    name: "Create",
    description: "AI content generation, classification, and streaming",
    icon: "Sparkles",
    color: "purple",
    toolCount: 0,
    tier: "free",
  ...
  },
  {
    id: "orbit-pulse",
    name: "Orbit Pulse",
    description: "Real-time social media analytics and pulse metrics",
    icon: "Activity",
    color: "pink",
    toolCount: 0,
    tier: "workspace",
  },
  {
    id: "orbit-inbox",
    name: "Orbit Inbox",
    description: "Unified inbox management with AI analysis and routing",
    icon: "Inbox",
    color: "blue",
    toolCount: 0,
    tier: "workspace",
  },
  {
    id: "orbit-calendar",
    name: "Orbit Calendar",
    description: "Content calendar, optimal timing, and scheduling",
    icon: "Calendar",
    color: "green",
    toolCount: 0,
    tier: "workspace",
  ...
  },
  {
    id: "orbit-boost",
    name: "Orbit Boost",
    description: "Performance optimization and boost recommendations",
    icon: "Zap",
    color: "fuchsia",
    toolCount: 0,
    tier: "workspace",
  },
  {
    id: "orbit-crisis",
    name: "Orbit Crisis",
    description: "Crisis detection, management, and response templates",
    icon: "Shield",
    color: "pink",
    toolCount: 0,
    tier: "workspace",
  },
  {
    id: "orbit-relay",
    name: "Orbit Relay",
    description: "Post publishing, scheduling, and draft management",
    icon: "Send",
    color: "purple",
    toolCount: 0,
    tier: "workspace",
  ...
  },
  {
    id: "workspace",
    name: "Workspace",
    description: "Team collaboration, brand management, and workflows",
    icon: "Users",
    color: "layers",
    toolCount: 0,
    tier: "workspace",
