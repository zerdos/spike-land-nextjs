 ...
 * ```
 */
export function ThemeProvider({ initialConfig, children, workspaceSlug }: ThemeProviderProps) {
  const [config, setConfig] = useState<WorkspaceWhiteLabelConfig | null>(initialConfig ?? null);
