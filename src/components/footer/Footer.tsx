      ...
      <div className="container mx-auto px-4 py-12 md:py-16 lg:py-20">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4 lg:col-span-2">
            <h4 className="text-sm font-semibold text-white font-heading">Subscribe to our newsletter</h4>
            <p className="text-sm text-muted-foreground">
              Get the latest updates on new features and AI advancements.
            </p>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="flex w-full max-w-sm items-start gap-2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      <FormControl>
                        <Input placeholder="Enter your email" {...field} className="bg-white/5 border-white/10 text-white placeholder:text-muted-foreground/60" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
