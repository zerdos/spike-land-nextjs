...
const CATEGORY_COLORS: Record<string, string> = {
  utility: "bg-blue-900/30 text-blue-300",
  visualization: "bg-purple-900/30 text-purple-300",
  productivity: "bg-green-900/30 text-green-300",
  interactive: "bg-amber-900/30 text-amber-300",
  health: "bg-red-900/30 text-red-300",
  dogs: "bg-orange-900/30 text-orange-300",
};
