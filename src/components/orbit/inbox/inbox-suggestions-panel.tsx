...
import { InboxSuggestedResponse } from "@prisma/client";
...
export function InboxSuggestionsPanel({ suggestions, onSelect, onRegenerate, isLoading }: InboxSuggestionsPanelProps) {
    ...
    return (
        <Card className="bg-blue-50/50 border-blue-100 mb-4">
            <CardHeader className="py-3 px-4 flex flex-row items-center justify-between">
                ...
                <Button variant="ghost" size="icon" className="h-6 w-6" onClick={onRegenerate} disabled={isLoading}>
