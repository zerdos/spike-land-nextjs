  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Manage all your social accounts with AI agents. Create content, schedule posts, and grow your audience."
      },
      {
        "@type": "Service",
        ...
        "name": "AI Automation",
        "description": "Relay drafts and Allocator autopilot for automated content creation and distribution."
      },
      {
        "@type": "Service",
