...
export async function generateMetadata({
  ...
  // Next.js automatically adds og:image meta tag pointing to /share/[token]/opengraph-image
  ...
  return {
    ...
    openGraph: {
      ...
      // images is auto-generated from opengraph-image.tsx
    },
    twitter: {
      card: "summary_large_image",
      title: `${image.name} - Enhanced with Pixel`,
      description: image.description ?? `View this AI-enhanced image created with Pixel`,
      // Twitter will use the OG image from opengraph-image.tsx
    },
  };
}
