...
export default function NYECountdownClient() {
  ...
  const hypeLevel = useMemo(() => {
    ...
    if (hours === 0) {
      return { level: 60, label: "HIGH", color: "from-purple-500 to-blue-500" };
    }
    if (hours < 3) {
      return {
        level: 45,
  ...
  return (
    ...
    >
      ...
      {isThirtyMinutesLeft && (
        <div className="fixed inset-0 pointer-events-none z-90 flex items-center justify-center">
          <div className="animate-one-hour-burst">
            <div className="text-5xl sm:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-purple-400 to-pink-500 animate-pulse tracking-wider">
              30 MINUTES!
            </div>
            <div className="absolute inset-0 bg-gradient-radial from-purple-400/30 via-purple-500/10 to-transparent blur-3xl scale-150" />
          </div>
        </div>
      )}
      ...
      {isComplete && (
        <>
          ...
          >
            <div className="w-full h-full rounded-full bg-gradient-to-br from-purple-400/40 to-blue-500/40 blur-xl" />
          </div>
          <div
      ...
      {isLastTenSeconds && (
        <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-25">
          <div className="relative">
            ...
            <div
              className="absolute inset-0 w-[400px] h-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-purple-500/40 animate-portal-spin"
      ...
      {isComplete && (
        <div className="fixed inset-0 pointer-events-none z-85 overflow-hidden">
          ...
          {/* Secondary flares */}
          <div
            className="absolute top-[40%] left-[60%] w-8 h-8 rounded-full bg-purple-400/40 blur-sm animate-lens-flare"
            style={{ animationDelay: "0.2s" }}
          />
          <div
          ...
          />
          {/* Anamorphic streak */}
          <div className="absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-purple-400/60 to-transparent -translate-y-1/2 animate-lens-streak" />
        </div>
      )}
      ...
      {isLastFiveSeconds && (
        <div className="fixed inset-0 pointer-events-none z-55">
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div
              key={`spark-${i}`}
              className="absolute w-1 h-1 bg-purple-400 rounded-full animate-spark"
              style={{
                top: `${20 + (i * 10) % 60}%`,
                left: `${10 + (i * 12) % 80}%`,
                animationDelay: `${i * 0.15}s`,
      ...
      {isFinalCountdown && !isComplete && (
        <div className="fixed inset-0 pointer-events-none z-35 overflow-hidden">
          ...
          />
          <div
            className="absolute w-[150px] h-[350px] bg-gradient-to-b from-purple-400/15 via-purple-400/5 to-transparent blur-xl animate-spotlight-sweep"
      ...
      {isFinalCountdown && !isComplete && (
        <div className="fixed inset-0 pointer-events-none z-15 overflow-hidden">
          ...
          <div
            className="absolute w-3 h-3 rounded-full bg-purple-400/60 blur-sm animate-energy-converge"
            style={{ top: "10%", left: "5%" }}
          />
          <div
        ...
        <div
          className={`absolute inset-x-0 -top-20 h-48 blur-3xl animate-aurora transition-opacity duration-1000 ${
            isFinalHour
              ...
              : "bg-gradient-to-b from-purple-500/20 via-purple-500/10 to-transparent opacity-100"
          }`}
        />
        <div
          className={`absolute inset-x-0 -top-10 h-32 blur-2xl animate-aurora transition-opacity duration-1000 ${
            isFinalHour
              ...
              : "bg-gradient-to-b from-pink-500/15 via-purple-500/10 to-transparent"
          }`}
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-[120px] animate-float-slow" />
      ...
      <div className="fixed inset-0 pointer-events-none z-10 overflow-hidden">
        ...
        <div className="absolute top-8 left-8 opacity-30">
          <div className="w-32 h-32 border-l-2 border-t-2 border-purple-400/50 rounded-tl-3xl" />
          <div className="absolute top-0 left-0 w-2 h-2 bg-purple-400 rounded-full animate-pulse" />
        </div>
        {/* Top right corner */}
      ...
      <div className="absolute top-[168px] left-4 z-50 hidden sm:flex items-center gap-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md px-3 py-2">
        ...
        <span className="text-purple-300/50 text-xs hidden sm:inline">
          watching
        </span>
          ...
          ? (
            <>
                ...
                <h1
                  className={`text-lg font-black tracking-[0.15em] sm:tracking-[0.3em] bg-clip-text text-transparent sm:text-3xl md:text-5xl animate-gradient-x transition-all duration-500 ${
                    isLastTenSeconds
                      ...
                      : "bg-gradient-to-r from-purple-400 via-purple-400 to-pink-400"
                  }`}
                >
              ...
              <div className="flex flex-col items-center">
                <div className="text-purple-400 font-mono text-base sm:text-lg md:text-xl tracking-widest text-glow-purple">
                  {currentTime}
                </div>
                <div className="text-purple-300/40 text-[10px] sm:text-xs mt-0.5 sm:mt-1">
                  {timezone}
                </div>
              </div>
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                ...
                />
                <p className="text-purple-300/60 tracking-[0.1em] sm:tracking-[0.2em] text-[10px] sm:text-xs uppercase">
              ...
              >
                ...
                <div className="absolute inset-[-20px] pointer-events-none">
                  <div className="absolute inset-0 rounded-full border border-purple-500/10 animate-countdown-ring" />
                ...
                {/* Pulse ring effect */}
                <div className="absolute inset-0 rounded-3xl border border-purple-500/20 animate-pulse-ring" />

                {/* Glow effect behind digits */}
                <div className="absolute inset-0 bg-gradient-to-b from-purple-500/5 to-purple-500/5 rounded-3xl blur-xl" />
                ...
                <div className="relative hidden sm:flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-10">
                  <CountdownDigit value={days} label="DAYS" />
                  <div className="flex items-center text-purple-400/40 text-4xl font-thin self-start mt-8">
                    :
                  </div>
                  <CountdownDigit value={hours} label="HOURS" />
                  <div className="flex items-center text-purple-400/40 text-4xl font-thin self-start mt-8">
              ...
              <div className="w-full max-w-md mt-2 sm:mt-4 px-2">
                <div className="flex justify-between text-[10px] sm:text-xs text-purple-300/50 mb-1 sm:mb-2">
                  <span>2025</span>
                  <span
                    className={`font-bold ${
                      yearProgress > 99.9
              ...
              {totalSecondsRemaining > 0 && totalSecondsRemaining < 86400 && (
                <div className="text-center">
                  <span className="text-purple-300/40 text-[10px] sm:text-xs uppercase tracking-wider sm:tracking-widest">
                    Only
                  </span>
                  <span className="mx-1 sm:mx-2 font-mono text-xl sm:text-2xl md:text-3xl font-bold text-purple-400 text-glow-purple">
              ...
              {!isFinalCountdown && (
                <p className="mt-4 max-w-md text-sm leading-relaxed text-purple-300/50 sm:text-base">
                  {hours < 1
          ...
          : (
            <div className="animate-banner-appear flex flex-col items-center gap-8">
              ...
              <div className="relative">
                ...
                <div
                  className="absolute inset-0 bg-gradient-to-r from-pink-500 via-yellow-400 to-purple-400 blur-2xl opacity-40 animate-pulse scale-125"
                  style={{ animationDelay: "-0.5s" }}
                />
                <div
                  className="absolute inset-0 bg-gradient-to-r from-purple-400 via-purple-500 to-pink-500 blur-xl opacity-30 animate-pulse scale-110"
                  style={{ animationDelay: "-1s" }}
                />
                ...
                <div className="relative rounded-2xl border-4 border-yellow-400/60 bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 px-8 py-6 shadow-[0_0_120px_rgba(234,179,8,0.7)] sm:px-16 sm:py-8 animate-heartbeat overflow-hidden">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-5xl font-black tracking-tight text-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.4)] sm:text-7xl md:text-9xl animate-text-shimmer bg-clip-text relative">
                      2026
                      {/* Prismatic overlay */}
                      <span className="absolute inset-0 bg-gradient-to-r from-red-400 via-yellow-300 via-green-400 via-purple-400 via-blue-400 to-purple-400 opacity-30 mix-blend-overlay animate-rainbow-pulse" />
                    </h1>
                    <Sparkles
                      className="h-10 w-10 text-white animate-spin"
                      style={{
              ...
              <div className="px-6 py-3 bg-white/5 backdrop-blur-md rounded-xl border border-white/10">
                <p className="text-lg sm:text-xl text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-purple-300 to-pink-300 font-medium transition-opacity duration-500">
      ...
      <div className="fixed inset-x-0 bottom-0 h-32 pointer-events-none z-0 overflow-hidden">
        <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-purple-900/20 via-purple-900/10 to-transparent blur-2xl animate-float-slow" />
      </div>
