...
describe("GET /api/orbit/[workspaceSlug]/allocator/facebook/campaigns", () => {
  it("should return campaigns for a valid workspace", async () => {
    ...
    (prisma.allocatorCampaign.findMany as any).mockResolvedValue([{ id: "camp1", name: "Campaign 1" }]);
  ...
  it("should return 404 if workspace is not found", async () => {
    ...
    const req = new NextRequest("http://localhost/api/orbit/non-existent-ws/allocator/facebook/campaigns");
