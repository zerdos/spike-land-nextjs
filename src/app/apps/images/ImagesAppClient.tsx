            ...
            return (
              <Card key={image.id} className="overflow-hidden">
                <div className="relative aspect-video bg-muted">
                  <Image
                    src={hasEnhancement && latestJob.enhancedUrl ? latestJob.enhancedUrl : image.originalUrl}
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    {image.originalWidth} × {image.originalHeight} · {(image.originalSizeBytes / 1024 / 1024).toFixed(2)} MB
                  </CardDescription>
                </CardHeader>
