...
describe('AppsLayout', () => {
  ...
  describe('Header Section', () => {
    ...
    it('should render header description', () => {
      render(<AppsLayout>{mockChildren}</AppsLayout>)
      expect(screen.getByText(/Discover and explore our curated collection of interactive apps/i)).toBeInTheDocument()
    })
  ...
  describe('Children Rendering', () => {
    it('should render single child element', () => {
      render(<AppsLayout><div>Single Child</div></AppsLayout>)
