      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          ...
          <Button
            ...
            disabled={!uploadedImage || enhancing || (tokenBalance !== null && tokenBalance < tierCosts[selectedTier])}
            className="w-full"
          >
        ...
        {job && (
          <Card className="p-6 md:col-span-2">
            ...
            <div className="mb-4">
              ...
              <p><strong>Tokens Used:</strong> {tierCosts[job.tier as keyof typeof tierCosts]}</p>
            </div>
