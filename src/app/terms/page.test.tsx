...
describe("Terms of Service Page", () => {
  ...
  describe("Acceptance of Terms Section", () => {
    it("should state terms agreement", () => {
      render(<TermsPage />);
      expect(
        screen.getByText(/By accessing and using the Pixel \(Spike Land\)/),
      )
        .toBeInTheDocument();
    });
    ...
    it("should specify age requirement", () => {
      render(<TermsPage />);
      expect(screen.getByText(/must be at least 13 years of age/))
        .toBeInTheDocument();
    });

    it("should state parental consent requirement", () => {
      render(<TermsPage />);
      expect(screen.getByText(/or have obtained parental consent/))
        .toBeInTheDocument();
    });
    ...
    it("should mention capacity to agree", () => {
      render(<TermsPage />);
      expect(screen.getByText(/legal capacity to enter into these Terms/))
        .toBeInTheDocument();
    });

    it("should mention UK jurisdiction", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("laws of the United Kingdom"))
        .toBe(true);
    });
    ...
    it("should mention consumer protection regulations", () => {
      const { container } = render(<TermsPage />);
      expect(
        container.textContent?.includes("UK consumer protection regulations"),
      ).toBe(true);
    });
  });
  ...
  describe("Account Terms Section", () => {
    it("should explain account creation", () => {
      render(<TermsPage />);
      expect(screen.getByText(/OAuth authentication providers/))
        .toBeInTheDocument();
      expect(screen.getByText(/including GitHub and Google/))
        .toBeInTheDocument();
    });

    it("should explain account security responsibility", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("solely responsible for")).toBe(
        true,
      );
      expect(
    ...
    it("should forbid multiple accounts", () => {
      render(<TermsPage />);
      expect(screen.getByText(/may maintain only one personal account/))
        .toBeInTheDocument();
      expect(screen.getByText(/Creating multiple accounts to circumvent/))
        .toBeInTheDocument();
    });
    ...
    it("should explain account deletion process", () => {
      render(<TermsPage />);
      expect(screen.getByText(/may delete your account at any time/))
        .toBeInTheDocument();
      expect(screen.getByText(/account will be disabled immediately/))
        .toBeInTheDocument();
    });
  });
  ...
  describe("Token Economy Section", () => {
    it("should explain what tokens are", () => {
      ...
      expect(
        screen.getByText(
          /Tokens are the currency used to purchase image enhancement services/,
        ),
      ).toBeInTheDocument();
      expect(
        screen.getByText(/non-refundable and non-transferable digital units/),
      )
        .toBeInTheDocument();
    });
    ...
    it("should explain free token generation", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("1 token per 15 minutes")).toBe(
        true,
      );
    ...
    it("should explain purchased tokens never expire", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Purchased tokens remain valid indefinitely/))
        .toBeInTheDocument();
    ...
    it("should explain non-refundable policy", () => {
      ...
      expect(
        screen.getByText(
          /cannot be refunded.*except in cases of failed enhancements/,
        ),
      )
        .toBeInTheDocument();
    });
    ...
    it("should explain non-transferable policy", () => {
      render(<TermsPage />);
      expect(screen.getByText(/cannot be transferred between accounts/))
        .toBeInTheDocument();
    });
    ...
    it("should mention token pricing flexibility", () => {
      render(<TermsPage />);
      expect(
        screen.getByText(/Token prices are subject to change without notice/),
      )
        .toBeInTheDocument();
    });
  ...
  describe("Service Description Section", () => {
    it("should describe service overview", () => {
      render(<TermsPage />);
      expect(screen.getByText(/AI-powered image processing service/))
        .toBeInTheDocument();
    ...
    it("should explain 1K enhancement", () => {
      render(<TermsPage />);
      expect(screen.getByText(/1K Enhancement \(1024x1024\)/))
        .toBeInTheDocument();
      expect(
        screen.getByText(
          /Standard resolution enhancement suitable for web use/,
        ),
      )
        .toBeInTheDocument();
    });
    ...
    it("should explain 2K enhancement", () => {
      render(<TermsPage />);
      expect(screen.getByText(/2K Enhancement \(2048x2048\)/))
        .toBeInTheDocument();
      expect(
        screen.getByText(/High-resolution enhancement suitable for printing/),
      )
        .toBeInTheDocument();
    });
    ...
    it("should explain 4K enhancement", () => {
      render(<TermsPage />);
      expect(screen.getByText(/4K Enhancement \(4096x4096\)/))
        .toBeInTheDocument();
      expect(screen.getByText(/Ultra-high resolution enhancement/))
        .toBeInTheDocument();
    });
    ...
    it("should mention Google Gemini processing", () => {
      ...
      expect(
        screen.getByText(
          /Image enhancements are processed using Google Gemini API/,
        ),
      )
        .toBeInTheDocument();
    ...
    it("should disclaim warranty of specific results", () => {
      render(<TermsPage />);
      expect(screen.getByText(/No Guarantee of Specific Results/))
        .toBeInTheDocument();
      expect(screen.getByText(/without any warranty regarding the quality/))
        .toBeInTheDocument();
    });
  ...
  describe("Acceptable Use Policy Section", () => {
    ...
    it("should mention CSAM prohibition", () => {
      render(<TermsPage />);
      expect(screen.getByText(/child sexual abuse material \(CSAM\)/))
        .toBeInTheDocument();
    });
    ...
    it("should explain copyright infringement reporting", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("contact us at hello@spike.land"))
        .toBe(true);
      expect(
        container.textContent?.includes(
    ...
    it("should list misuse prevention measures", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Circumvent rate limits or token limits/))
        .toBeInTheDocument();
      expect(screen.getByText(/Attempt to gain unauthorized access/))
        .toBeInTheDocument();
    });
    ...
    it("should list enforcement rights", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("reserve the right to")).toBe(
        true,
      );
      expect(
        container.textContent?.includes(
  ...
  describe("Intellectual Property Section", () => {
    it("should state user retains image ownership", () => {
      ...
      expect(
        screen.getByText(
          /retain all intellectual property rights and ownership/,
        ),
      )
        .toBeInTheDocument();
    });
    ...
    it("should explain platform license grant", () => {
      render(<TermsPage />);
      expect(screen.getByText(/limited, non-exclusive, revocable license/))
        .toBeInTheDocument();
      expect(screen.getByText(/Process and enhance your images/))
        .toBeInTheDocument();
    });
    ...
    it("should explicitly state no AI training", () => {
      ...
      expect(screen.getByText(/explicitly guarantee that:/))
        .toBeInTheDocument();
      expect(screen.getByText(/NOT used to train AI models/))
        .toBeInTheDocument();
    });

    it("should forbid facial recognition training", () => {
      render(<TermsPage />);
      expect(screen.getByText(/NOT analyzed for facial recognition training/))
        .toBeInTheDocument();
    });

    it("should forbid commercial sharing", () => {
      render(<TermsPage />);
      expect(screen.getByText(/NOT sold or shared for commercial purposes/))
        .toBeInTheDocument();
    });
    ...
    it("should explain platform IP ownership", () => {
      ...
      expect(container.textContent?.includes("owned by the Operator")).toBe(
        true,
      );
    });
    ...
    it("should list platform IP types", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("Software code and algorithms"))
        .toBe(true);
      expect(container.textContent?.includes("User interface design")).toBe(
        true,
      );
    });
  });
  ...
  describe("Payment Terms Section", () => {
    it("should specify GBP currency", () => {
      render(<TermsPage />);
      expect(screen.getByText(/British Pounds Sterling \(GBP\)/))
        .toBeInTheDocument();
    });
    ...
    it("should clarify credit card handling", () => {
      render(<TermsPage />);
      expect(screen.getByText(/do not store your credit card information/))
        .toBeInTheDocument();
    });
    ...
    it("should explain automatic renewal", () => {
      ...
      expect(screen.getByText(/You can cancel automatic renewals/))
        .toBeInTheDocument();
    });

    it("should explain general refund policy", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Token purchases are generally non-refundable/))
        .toBeInTheDocument();
    });
    ...
    it("should explain failed enhancement refund", () => {
      ...
      expect(
        screen.getByText(/enhancement request fails due to a service error/),
      )
        .toBeInTheDocument();
    });
    ...
    it("should explain billing error refund", () => {
      ...
      expect(screen.getByText(/charged twice or charged incorrectly/))
        .toBeInTheDocument();
    });
    ...
    it("should warn about chargeback consequences", () => {
      ...
      expect(screen.getByText(/dispute a charge with your card issuer/))
        .toBeInTheDocument();
    });
  ...
  describe("Limitation of Liability Section", () => {
    it("should state service provided as is", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Service is provided.*AS IS/))
        .toBeInTheDocument();
      expect(screen.getByText(/without warranties of any kind/))
        .toBeInTheDocument();
    });
    ...
    it("should list warranty disclaimers", () => {
      ...
      expect(screen.getByText(/Image enhancements will meet your expectations/))
        .toBeInTheDocument();
      expect(screen.getByText(/will be error-free or uninterrupted/))
        .toBeInTheDocument();
    });

    it("should disclaim consequential damages", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Disclaimer of Consequential Damages/))
        .toBeInTheDocument();
    ...
    it("should specify maximum liability cap", () => {
      ...
      expect(screen.getByText(/not exceed the total amount you have paid/))
        .toBeInTheDocument();
    });
    ...
    it("should mention force majeure", () => {
      ...
      expect(screen.getByText(/events beyond our reasonable control/))
        .toBeInTheDocument();
    });

    it("should list force majeure events", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Natural disasters, acts of God/))
        .toBeInTheDocument();
    ...
    it("should explain indemnification", () => {
      ...
      expect(screen.getByText(/hold harmless the Operator/))
        .toBeInTheDocument();
    });
    ...
    it("should list indemnification trigger events", () => {
      ...
      expect(screen.getByText(/Your violation of these Terms/))
        .toBeInTheDocument();
    });
  });
  ...
  describe("Dispute Resolution Section", () => {
    ...
    it("should specify response time", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("will respond within 30 days"))
        .toBe(true);
    });

    it("should specify jurisdiction and venue", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("Jurisdiction and Venue")).toBe(
        true,
      );
      expect(container.textContent?.includes("courts of England and Wales"))
        .toBe(true);
    });
    ...
    it("should limit remedies", () => {
      ...
      expect(container.textContent?.includes("sole and exclusive remedy")).toBe(
        true,
      );
    });
  ...
  describe("Changes to Terms Section", () => {
    it("should reserve right to modify terms", () => {
      render(<TermsPage />);
      expect(screen.getByText(/reserve the right to modify these Terms/))
        .toBeInTheDocument();
      expect(screen.getByText(/Changes are effective immediately/))
        .toBeInTheDocument();
    });
    ...
    it("should explain notice methods", () => {
      ...
      expect(screen.getByText(/Emailing you at your registered email address/))
        .toBeInTheDocument();
    });

    it("should mention last updated date tracking", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Updating the.*Last Updated.*date/))
        .toBeInTheDocument();
    });

    it("should explain acceptance by continued use", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Continued Use Constitutes Acceptance/))
        .toBeInTheDocument();
      expect(
        screen.getByText(
    ...
    it("should define material changes", () => {
      ...
      expect(screen.getByText(/Increase fees or token costs by more than 10%/))
        .toBeInTheDocument();
    });
  ...
  describe("Legal Disclaimer", () => {
    ...
    it("should state this is a template", () => {
      ...
      expect(
        container.textContent?.includes(
          "template for informational purposes only",
        ),
      ).toBe(
        true,
      );
    ...
    it("should recommend legal consultation", () => {
      ...
      expect(
        container.textContent?.includes(
          "technology law and consumer protection",
        ),
      ).toBe(true);
    });
    ...
    it("should mention jurisdiction variations", () => {
      ...
      expect(
        container.textContent?.includes(
          "customize them for your specific business model",
        ),
      )
        .toBe(true);
    });
    ...
    it("should warn against use without review", () => {
      ...
      expect(
        container.textContent?.includes(
          "should not be used without professional legal review",
        ),
      ).toBe(true);
    });
  });
  ...
  describe("Navigation and Links", () => {
    ...
    it("should link to all major sections", () => {
      const { container } = render(<TermsPage />);
      expect(container.querySelector('a[href="#acceptance"]'))
        .toBeInTheDocument();
      expect(container.querySelector('a[href="#account-terms"]'))
        .toBeInTheDocument();
      expect(container.querySelector('a[href="#token-economy"]'))
        .toBeInTheDocument();
      expect(container.querySelector('a[href="#service-description"]'))
        .toBeInTheDocument();
      expect(container.querySelector('a[href="#acceptable-use"]'))
        .toBeInTheDocument();
      expect(container.querySelector('a[href="#intellectual-property"]'))
        .toBeInTheDocument();
      expect(container.querySelector('a[href="#payment-terms"]'))
        .toBeInTheDocument();
      expect(container.querySelector('a[href="#limitation-liability"]'))
        .toBeInTheDocument();
      expect(container.querySelector('a[href="#dispute-resolution"]'))
        .toBeInTheDocument();
      expect(container.querySelector('a[href="#changes-terms"]'))
        .toBeInTheDocument();
    });
  ...
  describe("Compliance Coverage", () => {
    ...
    it("should cover age verification (13+)", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("at least 13 years of age")).toBe(
        true,
      );
    });
    ...
    it("should cover CSAM prohibition", () => {
      const { container } = render(<TermsPage />);
      expect(
        container.textContent?.includes("child sexual abuse material (CSAM)"),
      ).toBe(true);
    });
    ...
    it("should cover IP rights", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("Intellectual Property")).toBe(
        true,
      );
      expect(
        container.textContent?.includes(
    ...
    it("should cover payment terms", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("British Pounds Sterling")).toBe(
        true,
      );
    ...
    it("should cover limitation of liability", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("Limitation of Liability")).toBe(
        true,
      );
  ...
  describe("Content Completeness", () => {
    ...
    it("should cover acceptable use policies", () => {
      const { container } = render(<TermsPage />);
      expect(container.textContent?.includes("Acceptable Use Policy")).toBe(
        true,
      );
    ...
    it("should specify rate limits", () => {
      render(<TermsPage />);
      expect(screen.getByText(/20 image uploads per hour/)).toBeInTheDocument();
      expect(screen.getByText(/100 API requests per minute/))
        .toBeInTheDocument();
    });
  });
  ...
  describe("Financial Terms Specifics", () => {
    ...
    it("should mention chargeback fees", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Demand repayment of any chargeback fees/))
        .toBeInTheDocument();
    });

    it("should explain VAT inclusion", () => {
      render(<TermsPage />);
      expect(screen.getByText(/Prices displayed include VAT/))
        .toBeInTheDocument();
    });
  });
  ...
  describe("Token Policy Details", () => {
    ...
    it("should explain token generation pause at max", () => {
      render(<TermsPage />);
      expect(screen.getByText(/token generation pauses until you use tokens/))
        .toBeInTheDocument();
    });
