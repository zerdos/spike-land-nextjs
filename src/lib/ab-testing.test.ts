...
describe('A/B Testing Utilities', () => {
  ...
  describe('chiSquaredToPValue', () => {
    it('should return a p-value close to 0.05 for chi-squared of 3.84 and df=1', () => {
      expect(chiSquaredToPValue(3.84, 1)).toBeCloseTo(0.05, 2);
    });

    it('should return a p-value close to 0.01 for chi-squared of 6.63 and df=1', () => {
      expect(chiSquaredToPValue(6.63, 1)).toBeCloseTo(0.01, 2);
    });
  });
