...
export class WorkspaceAuditLogger {
   ...
   */
  static async logApprovalWorkflowCreate(
    workspaceId: string,
    userId: string,
    workflowId: string,
    name: string,
    ...
    return this.log({
      workspaceId,
      userId,
      action: "APPROVAL_WORKFLOW_CREATE" as AuditAction,
      targetId: workflowId,
  ...
  /**
   * Log approval item submission
   */
  static async logApprovalItemSubmit(
    workspaceId: string,
    userId: string,
    itemId: string,
    workflowId: string,
    ...
    return this.log({
      workspaceId,
      userId,
      action: "APPROVAL_ITEM_SUBMIT" as AuditAction,
      targetId: itemId,
      targetType: "approval_item",
      metadata: { workflowId, contentId, contentType },
      ipAddress,
      userAgent,
    });
  }
  ...
  static async logApprovalDecision(
    ...
    return this.log({
      workspaceId,
      userId,
      action: "APPROVAL_DECISION" as AuditAction,
      targetId: itemId,
      targetType: "approval_item",
      metadata: { stageId, decision, note },
      ipAddress,
      userAgent,
    });
  }
  ...
  static async logCommentCreate(
    ...
    return this.log({
      workspaceId,
      userId,
      action: "COMMENT_CREATE" as AuditAction,
      targetId: commentId,
