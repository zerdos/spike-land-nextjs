 ...
 *
 * Tier and role-based access control for white-label features.
 * Resolves #924
 */
 ...
 */
export function canAccessWhiteLabel(workspace: Pick<Workspace, "subscriptionTier">): boolean {
 ...
 */
export function canDeleteWhiteLabelConfig(member: Pick<WorkspaceMember, "role">): boolean {
