...
export function registerAppsTools(
  ...
  registry.register({
    ...
    handler: async ({ app_id, image_count }: z.infer<typeof AppsUploadImagesSchema>): Promise<CallToolResult> =>
  ...
  registry.register({
    ...
    description: "Generate a random codespace ID in the format 'adjective.noun.verb.suffix'. Useful for creating unique app identifiers.",
    category: "apps",
    tier: "free",
